...
setwd('X:/Sequencing_data/HY_10969/Data_analysis_shiju/ZT0vsZT12')

base_dir <- 'X:/Sequencing_data/HY_10969/Data_analysis_shiju/ZT0vsZT12/Kallisto_out'
...
top_genes<- test_table[1:4, "target_id"]
...
write.csv(DGE_all, 'DEG_10969-HY_ZT0vsZT12.csv')
