...
MAB_TS<-MAB_data[MAB_data$ext_gene %in% cycling_genes$ext_gene,]

MAB_TS_JTK<-merge(MAB_TS, cycling_genes[c('ext_gene', 'LAG')], by.x=1 , by.y="ext_gene")
...
write.csv(genes_ratio_all, '/home/shijusis/JTK_analysis/gene_ratio_all.csv')
...
genes_ratio_all<-genes_ratio_all[which((24-genes_ratio_all$LAG_diff)>=6), ]
 ...
 # write.csv(genes_ratio_all, 'Gene_ratio_all_MAB_6-18hr.csv')
 
 write.csv(genes_ratio_all, '/home/shijusis/JTK_analysis/Gene_ratio_all_MAB_6-18hr.csv')