...
write.csv(Count_matrix, 'X:/Sequencing_data/Clark_seq_data_6-12-2024/01.RawData/BT_all/Raw_count_matrix.csv')
head(Count_matrix)
...
normalized_counts <- GetAssayData(seurat, slot = "data")
normalized_counts_matrix <- as.matrix(normalized_counts)
write.csv(normalized_counts_matrix, 'X:/Sequencing_data/Clark_seq_data_6-12-2024/01.RawData/BT_all/Normalized_count_matrix.csv')
...
MK1<-FeaturePlot(seurat, features = "Pdf", min.cutoff = 'q10')
MK2<-FeaturePlot(seurat, features = "per", min.cutoff = 'q10')
MK3<-FeaturePlot(seurat, features = "Clk", min.cutoff = 'q10')
MK4<-FeaturePlot(seurat, features = "tim", min.cutoff = 'q10')
MK5<-FeaturePlot(seurat, features = "vri", min.cutoff = 'q10')
MK6<-FeaturePlot(seurat, features = "AstC", min.cutoff = 'q10')
library(gridExtra)
